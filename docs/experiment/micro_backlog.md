...
| 209 | `alignment_fits -> key_b` | `28683 -> 28079` | `0.0213` | exact micro | Found by case344 high-cost probe. Medium risk and below standalone threshold; bank for a future same-task bundle, not low-risk batch. |
